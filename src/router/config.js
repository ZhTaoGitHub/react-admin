export default {
  ...
  menus: [
    // 菜单相关路由
    { key: '/dashboard/index', title: '首页', icon: 'dashboard', component: 'Dashboard' },
    { key: '/member/index', title: '会员管理', icon: 'contacts', component: 'Member' },
    { key: '/setting/index', title: '设置', icon: 'setting', component: 'Setting' },
    // {
    //   key: '/app/ui',
    //   title: 'UI',
    //   icon: 'scan',
